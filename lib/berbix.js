...
Client.prototype.scanId = async function (tokens, idScanOpts) {
  if (!tokens) {
  ...
  const idScans = idScanOpts.idScans.method(is => (
    {
  ...
  return await this._upload(this, tokens, uploadEndpoint, payload);
}
